...
\begin{center}
\leavevmode
\includegraphics[width=140pt]{structRectangle__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=140pt]{structRectangle__coll__graph}
\end{center}
\end{figure}
...
bool {\bfseries Contains} (\mbox{\hyperlink{structPoint}{Point}} p)
\item 
...
std\+::vector$<$ \mbox{\hyperlink{structPoint}{Point}} $\ast$ $>$ {\bfseries m\+Corner\+Points}
\item 
